...
namespace gazebo {
    ...
    class HandPlugin : public ModelPlugin
    {
        ...
        /// Initial pose
        private: ignition::math::Pose3d init_pose {-0.05, -0.18, 0.05, 0.0, 0.0, 0.0};
	...
	private: bool check(HandMsgPtr &_msg);

	private: bool loop = false;
		std::chrono::high_resolution_clock::time_point stop, start, abs_start;
		std::string data;
		physics::JointPtr debug_joint;
		double ref;
		std::string file_name;
		int type;

		/*std::string data2;
		physics::JointPtr debug_joint2;
		std::string file_name2;

		std::string data3;
		physics::JointPtr debug_joint3;
		std::string file_name3;

		std::string data4;
		physics::LinkPtr debug_link;
